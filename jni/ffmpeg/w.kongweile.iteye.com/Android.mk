...
AVCODEC_C_FILES-$(CONFIG_AC3_ENCODER) += ac3enc_combined.c ac3enc_fixed.c 	ac3enc_float.c ac3tab.c ac3.c kbdwin.c ac3enc.c
...
AVCODEC_C_FILES-$(CONFIG_ADPCM_G722_DECODER) += g722.c
AVCODEC_C_FILES-$(CONFIG_ADPCM_G722_ENCODER) += g722.c
...
AVFORMAT_C_FILES-$(CONFIG_MP3_MUXER) += mp3enc.c rawenc.c
