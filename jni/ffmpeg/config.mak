...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-static --enable-shared --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --enable-small --cross-prefix=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --enable-cross-compile --target-os=linux --extra-cflags=-I/home/orange/working/graduating/android-ndk-r7/platforms/android-8/arch-arm/usr/include --extra-ldflags='-L/home/orange/working/graduating/android-ndk-r7/platforms/android-8/arch-arm/usr/lib -nostdlib' --arch=arm --disable-debug --disable-stripping
prefix=/usr/local
...
ARCH=arm
CC=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
RANLIB=/home/orange/workspace/graduating/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS= -I/home/orange/working/graduating/android-ndk-r7/platforms/android-8/arch-arm/usr/include  -std=c99 -fomit-frame-pointer -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -I/home/orange/working/graduating/android-ndk-r7/platforms/android-8/arch-arm/usr/include 
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L/home/orange/working/graduating/android-ndk-r7/platforms/android-8/arch-arm/usr/lib -nostdlib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
libavutil_VERSION=51.29.0
libavutil_VERSION_MAJOR=51
libavfilter_VERSION=2.49.0
...
ACODEC_TESTS=ac3_fixed adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam alac aref flac g723_1 g726 mp2 pcm wmav1 wmav2 
VCODEC_TESTS=amv asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 dv_411 error ffv1 flashsv2 flv h261 h263 h263p huffyuv jpeg2000 jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2_422 mpeg2_idct_int mpeg2_ilace mpeg2_ivlc_qprd mpeg2thread mpeg2thread_ilace mpeg4 mpeg4_adap mpeg4_qpel mpeg4_qprd mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 msvideo1 prores qtrle qtrlegray rc rgb roq rv10 rv20 snow snowll svq1 vref wmv1 wmv2 yuv 
